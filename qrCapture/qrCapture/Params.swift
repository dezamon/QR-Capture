...
let colorPink:UIColor = UIColor(red:0.85, green:0.25, blue:0.44, alpha:1.00)

// Highlight Colors
let hlColor1:UIColor = UIColor(red:0.88, green:0.32, blue:0.32, alpha:1.00)

// Font
let fontType:String = "HiraKakuProN-W6"
let fontFuturaM:String = "Futura-Medium"
let fontFuturaCM:String = "Futura-CondensedMedium"
...
let fontSizeM:CGFloat = 15
let fontSizeML:CGFloat = 18
let fontSizeMLL:CGFloat = 20
let fontSizeL:CGFloat = 25
